...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <form action="" method="post" name="showForm" ><table align="center"> 
		...
		<tr >
			<td colspan="2"><input type="button" name="showType" value="查看所有房间" onclick="showAll()"></td>
		</tr>
		<tr>
	 <td colspan="2"><input type="button" name="showType" value="查看预定订单" onclick="showReserve()"></td>
			</tr>
		<tr>
		  <td colspan="2"><input type="button" name="showType" value="查看入住订单" onclick="showCheckin()"></td>
		  </tr>
		  <tr>
			<td colspan="2"><input type="button" name="showType" value="查看历史订单" onclick="showFree()"></tr>
		<tr>
		  <td colspan="2"><input type="button" name="showType" value="查看所有员工" onclick="showCheckin()"></td>
		</tr>
	...
	<table align ="center">
		<tr>
			...
			<td colspan="2" width="100" align="center">描述</td>
	...
	<input type="submit" name="ok" value="修改房间信息" >
	<align="right">	
		<a>上一页</a> 
		<a> 下一页</a>
